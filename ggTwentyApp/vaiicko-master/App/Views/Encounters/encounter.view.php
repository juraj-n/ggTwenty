        ...
        <div class="col-12 col-md-6 col-lg-4 d-flex justify-content-center">
            <div class="enc-info-wrapper h-100">
                ...
                <div class="enc-info-topbar d-flex w-100 mb-3">
                    ...
                    <!-- Add button -->
                    <button type="button" class="enc-info-top-btn enc-info-add-btn ms-2" data-bs-toggle="modal" data-bs-target="#addOptionsModal">
                        Add
                    </button>
                    <!-- Delete button -->
                    <form method="post" action="<?= $link->url('encounters.deleteEncounter') ?>">
                        <input type="hidden" name="id" value="<?= $encounter->getId() ?>">
                        <button type="submit" class="enc-info-top-btn enc-info-del-btn ms-2">
                            Delete
                        </button>
                    </form>
                </div>
                ...
                <div class="list-group list-group-flush">
                    <?php foreach($dmmonsters as $monster): ?>
                        <form method="post" action="<?= $link->url('encounters.addMonster') ?>"
                            ...
                            <img src="<?= $monster->getImageUrl() ?>" alt="<?= $monster->getName() ?>" class="enc-modal-img me-2">
                            <div class="flex-grow-1 text-white">
                                <?= $monster->getName() ?>
                            </div>
                            <div class="enc-modal-init input-group input-group-sm">
                                ...
                                <button type="submit" class="enc-info-top-btn enc-info-add-btn">
                                    Add
                                </button>
                            </div>
                        </form>
